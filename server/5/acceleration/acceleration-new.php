...
echo "Requested URI: ".$_SERVER['REQUEST_URI']."<br>"; 
echo "Content Length: ".$_SERVER['CONTENT_LENGTH']." </font><vr>&nbsp;</p>";
?>
<br>
<?php
...
<a href='/acceleration/acceleration3.html'>Acceleration Example</a><br>
...
<tr>
<td width=550><font face=Arial size=2> Copyright 2013 - Proprietary and Confidential Information of F5 Networks<br>Security Level Classification - Sensitive</font></td>
