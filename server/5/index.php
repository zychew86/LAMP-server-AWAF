<html>
<head>
<TITLE>Using virtual server <? echo $_SERVER['HTTP_HOST']; ?> and pool member <? echo $_SERVER['SERVER_ADDR']; ?> (Node #5)</TITLE>
...
<p><font face=Arial>The <i>index.php</i> page is from <font color="003399"><b>Node #5</font></b><br>
